...
class SnakeNN:
    def __init__(self, initial_games = 5000, test_games = 20, goal_steps = 1000, lr = 1e-1, filename = 'snakenn2.tflearn',gui=True):
            ...
            for _ in range(self.goal_steps):
                ...
                if done:
                    ...
                    if score > prev_score or food_distance < prev_food_distance:
                        training_data.append([self.add_action_to_observation(prev_observation, action), 4])
                    else:
